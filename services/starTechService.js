...
function buildStarCard(period, company, meta, bars1D, periodBarsRaw, ytdBars) {
  ...
  return {
    ...
    peRatioFwd: null,
    peRatioFwdLoss: false,
    peRatioCurrent: null,
    peRatioCurrentLoss: false,
    marketCapCN: null,
